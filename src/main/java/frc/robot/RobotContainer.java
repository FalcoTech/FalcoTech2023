...
public class RobotContainer {
  ...
  XboxController Pilot = new XboxController(OperatorConstants.PilotControllerPort);
  XboxController CoPilot = new XboxController(OperatorConstants.CoPilotControllerPort);

  public double PilotGetLeftY(){
    return Pilot.getLeftY();
  }

  public double PilotGetRightX(){
